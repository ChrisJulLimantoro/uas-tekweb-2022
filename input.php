...
<?php
    if(isset($_POST['ajax'])){
        ...
        foreach($row as $r){
            ...
            echo "<td><button class='btn btn-warning me-lg-3' id='btn-edit' data-bs-toggle='modal' data-bs-target='#exampleModal'>Entry Log <i class='fa-solid fa-pen-to-square'></i></button><button class='btn btn-danger' id='btn-del'>Delete <i class='fa-solid fa-trash'></i></button></td>";
        }
        exit();
    }
?>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="admin.php">user_Admin</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <tbody class="table-light" id= "view">
                        <?php
                            ...
                            foreach($row as $r){
                                echo "<tr><td class='tgl-resi'>".$r['tanggal_resi']."</td>";
                                echo "<td class='no-resi'>".$r['no_resi']."</td>";
                                echo "<td><button class='btn btn-warning me-lg-3' id='btn-edit'>Entry Log <i class='fa-solid fa-pen-to-square'></i></button><button class='btn btn-danger' id='btn-del'>Delete <i class='fa-solid fa-trash'></i></button></td></tr>";
                            }
                        ?>
                    </tbody>
                </table>
